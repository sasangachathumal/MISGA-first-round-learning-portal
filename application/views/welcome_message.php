		...
		<div class="container">
			<div class="about-main about1">
				...
				<div class="col-md-4 about-gd1">
					<img src="<?php echo base_url(); ?>resources/images/video.jpg" class="img-responsive" alt="">
				</div>
		...
		<div class="container">
			...
			<div class="inner_sec_w3_agileinfo">
				...
				<div class="col-md-6 edu_img">
					<img src="<?php echo base_url(); ?>resources/images/stretch.jpg" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
					...
					<div id="myCarousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g1.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Business &amp; Management</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g2.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Data Structures</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g3.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Digital Marketing</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g4.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Financial Analyst Course</h5>
									</div>
								</div>
							</div>
							<div class="item">
								<div class="row">
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g5.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Arts &amp; Media </h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g6.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Literature</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g7.jpg" alt="Image" style="max-width:100%;"></div>
										<h5>Study Skills</h5>
									</div>
									<div class="col-md-3 col-sm-3 col-xs-3 slidering">
										<div class="thumbnail"><img src="<?php echo base_url(); ?>resources/images/g1.jpg" alt="Image" style="max-width:100%;"></div>
					...
					<div id="parentVerticalTab">
						...
						<div class="resp-tabs-container hor_1">
							<div class="text-info">
								...
								<img src="<?php echo base_url(); ?>resources/images/banner1.jpg" alt=" " class="img-responsive" />
							...
							<div class="text-info">
								...
								<p class="sec">Consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
									voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid
									ex ea commodi consequatur.</p>
								<img src="<?php echo base_url(); ?>resources/images/banner2.jpg" alt=" " class="img-responsive" />
							...
							<div class="text-info">
								...
								<p class="sec">Consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat
									voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid
									ex ea commodi consequatur.</p>
								<img src="<?php echo base_url(); ?>resources/images/banner3.jpg" alt=" " class="img-responsive" />
